...
class ShowProfilePageView(DetailView):
    model = Profile
    template_name = 'blog/Otherprofile.html'
...
class CreateProfilePageView(CreateView):
    ...
    template_name="blog/create_user_profile.html"
...
def search(request):
    ...
    return render(request, 'blog/search.html', { 'user_profile':user_profile,'username_profile_list': username_profile_list,'username_profile':username_profile})
